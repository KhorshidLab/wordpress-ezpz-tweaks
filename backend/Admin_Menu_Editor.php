 ...
 */
class Admin_Menu_Editor extends Base {
	...
	public function initialize() {
		...
		add_action( 'adminmenu', array( $this, 'add_admin_menu_button' ) );
	...
	public function add_admin_menu_button() {
		...
		?>
		<li id="admin-menu-editor-edit" class="hide-if-no-js">
			<a href="#" class="menu-top" title="<?php esc_attr_e( 'Edit Menu', EZPZ_TWEAKS_TEXTDOMAIN ); ?>">
				<div class="wp-menu-image dashicons-before dashicons-edit"></div>
				<div class="wp-menu-name"><?php _e( 'Edit Menu', EZPZ_TWEAKS_TEXTDOMAIN ); ?></div>
			</a>
		</li>
		<?php
	}
